...
### PLOT DISTANCE VS DAY v0=8 VENUS ###
...
### PLOT DISTANCE VS DAY ZOOM v0=8 VENUS ###

data = pd.read_csv("/home/agusosimani/Documents/ss-tp1/src/main/java/Mars/graficos/venusV10Every16Minutes", names=["day", "distance",], header=None)
plt.plot(data['day'], data['distance'], "o", linestyle="None", color="blue", markersize=2)
plt.yscale('log')
plt.xlabel("Minutos transcurridos a partir de las 00:00hs del 12/7/2020")
plt.ylabel("Distancia de la nave a Marte [m]")
plt.grid()
plt.show()